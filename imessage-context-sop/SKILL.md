...
description: |
  iMessage context search — when Author uses 指示代词, search chat history first.
  Burned 2026-07-07 — Author: "每次我使用到指示代词或者讲到了之前的内容时，先搜索imessage历史记录"
  Triggered by: 任何 "那个/这个/上次/前几天/之前说的/你记得吗" 等指示代词
---

# iMessage Context Search SOP

> 当 Author 用指示代词引用之前的内容时，必须先搜索 iMessage 历史记录再回复。
> Burned 2026-07-07
