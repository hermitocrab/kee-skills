...
```
Author 6/30: 修mindmap格式 → 英文加粗居中 + 中文单独一行 ✗3次才修对
Author 7/1: 更新SOP加入新的printables布局要求
...
3. **写清楚改了什么** — 回复 Author 时说"保留了X条，替换了Y条，新加了Z条"
...
- ❌ "这个规则好像过时了" → 不是你来判断，Author 没说的都保留
