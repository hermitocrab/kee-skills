...
## WHEN TO LOAD
When Author references past conversations, previous methods, or "yesterday's approach" that aren't in current session memory. ALWAYS before claiming "I don't know how this was done."
...
Reconstruct: what Author asked → what was built → what method was used → what was deployed
